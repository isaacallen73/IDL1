...
# Using breakout board footprint (much easier to solder than bare LGA-14 chip)
imu = Part(f'{kicad_sym}/Connector_Generic.kicad_sym', 'Conn_01x08', ref='U2', value='BMI160_Breakout',
...
print("OK Circuit definition complete!")
...
try:
    ...
    print("OK Netlist generated: output/datalogger.net")
...
try:
    ...
    print("WARNING ERC warnings (review above)")
...
with open('output/place_components.py', 'w') as f:
    f.write(placement)
print("OK Placement script: output/place_components.py")
...
with open('output/README.md', 'w') as f:
    f.write(readme)
print("OK Instructions: output/README.md")
...
Generated files in output/:
  OK datalogger.net - KiCad netlist
  OK place_components.py - Automated placement
  OK README.md - Complete workflow guide
